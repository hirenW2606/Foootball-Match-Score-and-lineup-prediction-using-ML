...
?>
                    <script type="text/javascript">
                        ...
                        window.location="./viewlineup.php";
                    </script>
          ...
          <div class="col-lg-12">
              ...
              <div class="form-row">
                <div class="col-md-6 form-group">
                  <select class="form-control" type="text" name="a" id="a" > 
					  <option value="Mancity" disable selected>Mancity</option>
				  </select>
					
                 
                </div>
                <div class="col-md-6 form-group">
                  <select class="form-control" type="text" name="b"  id="bteam"  > 
              ...
              <div class="text-center">
				  <input class="but" type="submit" name="submit" value="LineUp" />
				</div>
